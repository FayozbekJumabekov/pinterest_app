...
List<Pinterest> unSplashFromJson(String str) => List.from(jsonDecode(str).map((e) => Pinterest.fromJson(e)));

String unSplashToJson(List<Pinterest> data) => jsonEncode(List.from(data.map((e) => e.toJson())));
